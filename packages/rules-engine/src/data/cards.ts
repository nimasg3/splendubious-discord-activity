...
// =============================================================================
// TEST OVERRIDES — set to false to revert all test changes
// =============================================================================
export const TEST_OVERRIDES = false;
...
export const TIER_2_CARDS: DevelopmentCard[] = [
  // Sapphire bonus cards — Blue in CSV (6 cards)
  { id: 't2_s01', tier: 2, cost: cost({ ruby: 3, sapphire: 2, emerald: 2 }), bonus: 'sapphire', prestigePoints: 1 },
  { id: 't2_s02', tier: 2, cost: cost({ onyx: 3, sapphire: 2, emerald: 3 }), bonus: 'sapphire', prestigePoints: 1 },
  { id: 't2_s03', tier: 2, cost: cost({ diamond: 5, sapphire: 3 }), bonus: 'sapphire', prestigePoints: 2 },
  { id: 't2_s04', tier: 2, cost: cost({ sapphire: 5 }), bonus: 'sapphire', prestigePoints: 2 },
  { id: 't2_s05', tier: 2, cost: cost({ onyx: 4, diamond: 2, ruby: 1 }), bonus: 'sapphire', prestigePoints: 2 },
  { id: 't2_s06', tier: 2, cost: cost({ sapphire: 6 }), bonus: 'sapphire', prestigePoints: 3 },

  // Onyx bonus cards — Black in CSV (6 cards)
  { id: 't2_o01', tier: 2, cost: cost({ diamond: 3, sapphire: 2, emerald: 2 }), bonus: 'onyx', prestigePoints: 1 },
  { id: 't2_o02', tier: 2, cost: cost({ onyx: 2, diamond: 3, emerald: 3 }), bonus: 'onyx', prestigePoints: 1 },
  { id: 't2_o03', tier: 2, cost: cost({ ruby: 2, sapphire: 1, emerald: 4 }), bonus: 'onyx', prestigePoints: 2 },
  { id: 't2_o04', tier: 2, cost: cost({ diamond: 5 }), bonus: 'onyx', prestigePoints: 2 },
  { id: 't2_o05', tier: 2, cost: cost({ ruby: 3, emerald: 5 }), bonus: 'onyx', prestigePoints: 2 },
  { id: 't2_o06', tier: 2, cost: cost({ onyx: 6 }), bonus: 'onyx', prestigePoints: 3 },

  // Emerald bonus cards — Green in CSV (6 cards)
  { id: 't2_e01', tier: 2, cost: cost({ diamond: 3, ruby: 3, emerald: 2 }), bonus: 'emerald', prestigePoints: 1 },
  { id: 't2_e02', tier: 2, cost: cost({ onyx: 2, diamond: 2, sapphire: 3 }), bonus: 'emerald', prestigePoints: 1 },
  { id: 't2_e03', tier: 2, cost: cost({ onyx: 1, diamond: 4, sapphire: 2 }), bonus: 'emerald', prestigePoints: 2 },
  { id: 't2_e04', tier: 2, cost: cost({ emerald: 5 }), bonus: 'emerald', prestigePoints: 2 },
  { id: 't2_e05', tier: 2, cost: cost({ sapphire: 5, emerald: 3 }), bonus: 'emerald', prestigePoints: 2 },
  { id: 't2_e06', tier: 2, cost: cost({ emerald: 6 }), bonus: 'emerald', prestigePoints: 3 },

  // Ruby bonus cards — Red in CSV (6 cards)
  { id: 't2_r01', tier: 2, cost: cost({ onyx: 3, ruby: 2, sapphire: 3 }), bonus: 'ruby', prestigePoints: 1 },
  { id: 't2_r02', tier: 2, cost: cost({ onyx: 3, diamond: 2, ruby: 2 }), bonus: 'ruby', prestigePoints: 1 },
  { id: 't2_r03', tier: 2, cost: cost({ diamond: 1, sapphire: 4, emerald: 2 }), bonus: 'ruby', prestigePoints: 2 },
  { id: 't2_r04', tier: 2, cost: cost({ onyx: 5, diamond: 3 }), bonus: 'ruby', prestigePoints: 2 },
  { id: 't2_r05', tier: 2, cost: cost({ onyx: 5 }), bonus: 'ruby', prestigePoints: 2 },
  { id: 't2_r06', tier: 2, cost: cost({ ruby: 6 }), bonus: 'ruby', prestigePoints: 3 },

  // Diamond bonus cards — White in CSV (6 cards)
  { id: 't2_d01', tier: 2, cost: cost({ onyx: 2, ruby: 2, emerald: 3 }), bonus: 'diamond', prestigePoints: 1 },
  { id: 't2_d02', tier: 2, cost: cost({ diamond: 2, ruby: 3, sapphire: 3 }), bonus: 'diamond', prestigePoints: 1 },
  { id: 't2_d03', tier: 2, cost: cost({ onyx: 2, ruby: 4, emerald: 1 }), bonus: 'diamond', prestigePoints: 2 },
  { id: 't2_d04', tier: 2, cost: cost({ ruby: 5 }), bonus: 'diamond', prestigePoints: 2 },
  { id: 't2_d05', tier: 2, cost: cost({ onyx: 3, ruby: 5 }), bonus: 'diamond', prestigePoints: 2 },
  { id: 't2_d06', tier: 2, cost: cost({ diamond: 6 }), bonus: 'diamond', prestigePoints: 3 },
];
...
export const TIER_3_CARDS: DevelopmentCard[] = [
  // Sapphire bonus cards — Blue in CSV (4 cards)
  { id: 't3_s01', tier: 3, cost: cost({ onyx: 5, diamond: 3, ruby: 3, emerald: 3 }), bonus: 'sapphire', prestigePoints: 3 },
  { id: 't3_s02', tier: 3, cost: cost({ diamond: 7 }), bonus: 'sapphire', prestigePoints: 4 },
  { id: 't3_s03', tier: 3, cost: cost({ onyx: 3, diamond: 6, sapphire: 3 }), bonus: 'sapphire', prestigePoints: 4 },
  { id: 't3_s04', tier: 3, cost: cost({ diamond: 7, sapphire: 3 }), bonus: 'sapphire', prestigePoints: 5 },

  // Onyx bonus cards — Black in CSV (4 cards)
  { id: 't3_o01', tier: 3, cost: cost({ diamond: 3, ruby: 3, sapphire: 3, emerald: 5 }), bonus: 'onyx', prestigePoints: 3 },
  { id: 't3_o02', tier: 3, cost: cost({ ruby: 7 }), bonus: 'onyx', prestigePoints: 4 },
  { id: 't3_o03', tier: 3, cost: cost({ onyx: 3, ruby: 6, emerald: 3 }), bonus: 'onyx', prestigePoints: 4 },
  { id: 't3_o04', tier: 3, cost: cost({ onyx: 3, ruby: 7 }), bonus: 'onyx', prestigePoints: 5 },

  // Emerald bonus cards — Green in CSV (4 cards)
  { id: 't3_e01', tier: 3, cost: cost({ onyx: 3, diamond: 5, ruby: 3, sapphire: 3 }), bonus: 'emerald', prestigePoints: 3 },
  { id: 't3_e02', tier: 3, cost: cost({ diamond: 3, sapphire: 6, emerald: 3 }), bonus: 'emerald', prestigePoints: 4 },
  { id: 't3_e03', tier: 3, cost: cost({ sapphire: 7 }), bonus: 'emerald', prestigePoints: 4 },
  { id: 't3_e04', tier: 3, cost: cost({ sapphire: 7, emerald: 3 }), bonus: 'emerald', prestigePoints: 5 },

  // Ruby bonus cards — Red in CSV (4 cards)
  { id: 't3_r01', tier: 3, cost: cost({ onyx: 3, diamond: 3, sapphire: 5, emerald: 3 }), bonus: 'ruby', prestigePoints: 3 },
  { id: 't3_r02', tier: 3, cost: cost({ emerald: 7 }), bonus: 'ruby', prestigePoints: 4 },
  { id: 't3_r03', tier: 3, cost: cost({ ruby: 3, sapphire: 3, emerald: 6 }), bonus: 'ruby', prestigePoints: 4 },
  { id: 't3_r04', tier: 3, cost: cost({ ruby: 3, emerald: 7 }), bonus: 'ruby', prestigePoints: 5 },

  // Diamond bonus cards — White in CSV (4 cards)
  { id: 't3_d01', tier: 3, cost: cost({ onyx: 3, ruby: 5, sapphire: 3, emerald: 3 }), bonus: 'diamond', prestigePoints: 3 },
  { id: 't3_d02', tier: 3, cost: cost({ onyx: 7 }), bonus: 'diamond', prestigePoints: 4 },
  { id: 't3_d03', tier: 3, cost: cost({ onyx: 6, diamond: 3, ruby: 3 }), bonus: 'diamond', prestigePoints: 4 },
  { id: 't3_d04', tier: 3, cost: cost({ onyx: 7, diamond: 3 }), bonus: 'diamond', prestigePoints: 5 },
];

// =============================================================================
// NOBLES (10 nobles: 5 with 4+4, 5 with 3+3+3)
// =============================================================================

export const NOBLES: Noble[] = [
  // 4+4 requirement nobles (5 nobles)
  { id: 'noble_01', requirements: cost({ diamond: 4, sapphire: 4 }), prestigePoints: 3 },
  ...
  { id: 'noble_04', requirements: TEST_OVERRIDES ? cost({ diamond: 1 }) : cost({ ruby: 4, onyx: 4 }), prestigePoints: 3 },
  { id: 'noble_05', requirements: cost({ onyx: 4, diamond: 4 }), prestigePoints: 3 },

  // 3+3+3 requirement nobles (5 nobles)
  ...
  { id: 'noble_09', requirements: cost({ ruby: 3, onyx: 3, diamond: 3 }), prestigePoints: 3 },
  { id: 'noble_10', requirements: cost({ onyx: 3, diamond: 3, sapphire: 3 }), prestigePoints: 3 },
];
